...
import random
import re
from utils import beam_relation, get_candidate_relations
...
class MyRLDataLoader:
    ...
    def get_train_data(self):
        rl_train_datas = []
        lcquad1_train_datas = self._get_data('../datas/LC-QuAD-1.0/sparl_lcquad1_train_data.json')
        self.train_datas = lcquad1_train_datas
        ...
        for i in range(len(self.train_datas)):
            if len(self.train_datas[i]['gold_relation'].split()) <= 3:
                ...
                candidate_relations = get_candidate_relations(gold_relation, candidate_relations,
    ...
    def get_test_data(self):
        lcquad1_test_datas = self._get_data('../datas/LC-QuAD-1.0/sparl_lcquad1_test_data.json')
        rl_test_datas = self.test_data_generation(lcquad1_test_datas)
