...
class MyRLDataLoader:
    ...
    def get_train_data(self):
        rl_train_datas = []
        lcquad1_train_datas = self._get_data('../datas/LC-QuAD-2.0/sparl_lcquad2_train_data.json')
    ...
    def get_test_data(self):
        lcquad2_test_datas = self._get_data('../datas/LC-QuAD-2.0/sparl_lcquad2_test_data.json')
        rl_test_datas = self.test_data_generation(lcquad2_test_datas)
