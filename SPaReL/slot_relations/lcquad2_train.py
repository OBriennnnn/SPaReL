...
mslpdl_lcquad2 = MySLPDataLoader(train_data_name='../datas/LC-QuAD-2.0/sparl_lcquad2_train_data.json',
                                 test_data_name='../datas/LC-QuAD-2.0/sparl_lcquad2_test_data.json')
lcquad2_train_datas, lcquad2_test_datas = mslpdl_lcquad2.data_generation(num_of_slot_negative_data=3, batch_size=50)

train_datas = lcquad2_train_datas
test_datas = lcquad2_test_datas
