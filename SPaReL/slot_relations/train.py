...
# mslpdl_lcquad1 = MySLPDataLoader(train_data_path='../datas/LC-QuAD-1.0/sparl_lcquad1_train_data.json',
...
mslpdl_qald9 = MySLPDataLoader(train_data_path='../datas/QALD-9/sparl_qald9_train_data.json',
                               test_data_name='../datas/QALD-9/sparl_qald9_test_data.json')
qald9_train_datas, qald9_test_datas = mslpdl_qald9.data_generation(num_of_slot_negative_data=10, batch_size=20)
print(len(qald9_train_datas), len(qald9_test_datas))

train_datas = qald9_train_datas
test_datas = qald9_test_datas
